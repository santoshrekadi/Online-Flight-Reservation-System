...
Public Class Oneway
    ...
    Dim displayQuery As String = "select * from OnewayTbl"
    Dim command As New SqlCommand(displayQuery, con)
    Dim da2 As New SqlDataAdapter(command)
    Dim tb As New DataTable
    Dim counter As Integer = 0
    Private Sub Oneway_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Set Time to Label1'
    ...
    Private Sub Save_Click(sender As Object, e As EventArgs) Handles Save.Click
        Dim Insertquery As String = "insert into OnewayTbl(flight_type,source,destination,fare,tax,total_fare,date1,adults,children,infants,cabin_class,fare_type) values(@flight_type,@source,@destination,@fare,@tax,@total_fare,@date1,@adults,@children,@infants,@cabin_class,@fare_type)"
